...
# tworze distance ktory dla kazdego wierzcholka ma tablice dlugosci d, pod kazdym indeksem jest zapisana dlugosc najkrotszej
# trasy takiej ze dojedzamy z inx paliwa do wietrzchołka
